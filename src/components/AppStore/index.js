        ...
        <div className="app-store">
          ...
          <div className="search-input-container">
            <input
              ...
              onChange={this.changeSearchResult}
            />
            <img
          ...
          <ul className="tabs-list">
            {tabsList.map(tabItem => (
              <TabItem
                tabDetails={tabItem}
                key={tabItem.tabId}
                isActive={tabItem.tabId === tab.tabId}
                changeTabResult={this.changeTabResult}
              />
            ))}
          </ul>
